                    ...
                    return (
                      <tr
                        ...
                        className={`cursor-pointer transition-colors ${
                          isSelected
                            ? 'bg-nds/10 hover:bg-nds/15'
                            : 'hover:bg-base-750/30'
                        }`}
                      >
                        <td className="px-4 py-3 font-mono font-semibold text-nds hover:underline">
                          {vrf.name}
                        </td>
            ...
            <>
              ...
              <div className="p-4 border-b border-base-600/50 bg-base-900/50 space-y-3">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  <div>
                    <span className="text-[10px] font-mono text-nds uppercase tracking-wide">
